    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('farmer', 'Farmer'), ('financial_institution', 'Financial Institution'), ('admin', 'Admin')], default='farmer', max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution_type', models.CharField(choices=[('bank', 'Bank'), ('nbfc', 'NBFC'), ('mfi', 'Microfinance Institution'), ('other', 'Other')], max_length=50)),
